...
loss_func = partial(fgsm_loss, epsilon_fgsm=0.001, lambda_fgsm=0.01)
...
results = run_experiment(
    ...
    epochs=EPOCHS,
    patience=PATIENCE,
    model_save_path=os.path.join(MODELS_DIR, "bilstm_fgsm.pth")
)

import json
with open(os.path.join(RESULTS_DIR, "bilstm_fgsm.json"), "w") as f:
    json.dump(results, f, indent=4)
print("bilstm_fgsm completed")