...
loss_func = partial(sam_fgsm_loss,
                    ...
                    epsilon_fgsm=0.001,  # FGSM input perturbation intensity
                    lambda_fgsm=0.01)    # FGSM loss weight
...
results = run_experiment(
    ...
    epochs=EPOCHS,
    patience=PATIENCE,
    model_save_path=os.path.join(MODELS_DIR, "lstm_sam_fgsm.pth")
)

# ------------------------------ Save the results -------------------------------
import json
out_path = os.path.join(RESULTS_DIR, "lstm_sam_fgsm.json")
